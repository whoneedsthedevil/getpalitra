...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_dist_vue_js__ = __webpack_require__(2);
...
var app = new __WEBPACK_IMPORTED_MODULE_1_vue_dist_vue_js___default.a({
  el: '#app-content',
  data: function () {
    ...
    getPrimaryColors: function () {
      ...
      img.onload = function () {
        ...
        for (var i = 0; i < colorCount; i++) {
          $('.color', '.thief.palette').eq(i).css('background', 'rgb(' + palette[i][0] + ',' + palette[i][1] + ',' + palette[i][2] + ')');
        }
      };
    ...
    tryRessemble: function (imageSrc) {
      return resemble(imageSrc).onComplete(function (data) {
        ...
        for (let color in data) {
          console.log(color);
          $('.resemble.palette .color.' + color).animate({
            borderRadius: '0'
          }, 400).text(data[color]);
        }
